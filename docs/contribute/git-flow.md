...
To contribute to base-learn-template project on [GitHub](https://github.com/luismayta/base-learn-template), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/base-learn-template/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to base-learn-template project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/base-learn-template.git
```

Now your **upstream** points to **luismayta/base-learn-template**.
...
git fetch upstream # assuming upstream is rfid/base-learn-template
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/base-learn-template/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
